...
export const blockCrossSiteDEV = (req, res, allowedDevOrigins, hostname)=>{
    ...
    const parsedOrigin = rawOrigin && rawOrigin !== 'null' ? parseUrl(rawOrigin) : rawOrigin;
    ...
    return originLowerCase !== undefined && !isCsrfOriginAllowed(originLowerCase, allowedOrigins) && warnOrBlockRequest(res, originLowerCase, mode);
};
